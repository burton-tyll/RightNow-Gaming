<?php
    ...
    $newGames = $game_platform->getAllGamesByPlatformOrderedByDate(4);
    $bestSellers = $game_platform->getAllGamesByPlatformOrderedByRate(4);
    $theBestGame = $game_platform->getTheBestGameByPlateform(4);
    ...
    <main>
        ...
        <section id="nouveautés">
            <div class="section-title">
                <h1>Nouveautés</h1><a class="showmore" href="./newGames.php?games=nintendo"><img src="../img/arrow_down.png" alt="flèche bas"></a>
            </div>
        ...
        <section id="meilleures-ventes">
            <div class="section-title">
                <h1>Les mieux notés</h1><a class="showmore" href="./best-ratedgames.php?games=nintendo"><img src="../img/arrow_down.png" alt="flèche bas"></a>
            </div>
            <div class="games-grid">
                <?php
                $count = 0;
